...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    dateTitleLabel.hidden = YES;
    imageView.hidden = YES;
    addButton.hidden = YES;
    
    //FAKE REQUEST
    /*barcode = @"32044106031479";
    ...
    nameField.hidden = NO;
    nameField.text = @"Reindeer";
    dateLabel.hidden = NO;
    dateTitleLabel.hidden = NO;
    ...
    UIImage * image = [UIImage imageNamed:@"book-cover.png"];
    ...
    NSLog(@"uniqueid %@", newUniqueIDString);
    ...
    barcode = @"232323298";
    dateLabel.text = @"03/14/2014 12:00 pm";*/
    //END FAKE DATA

...
{
    static NSString *CellIdentifier = @"WildItemCell";
    static NSString *CellNib = @"WildItemCell";
    
    WildItemCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
    ...
    NSDate *dateUsed = [p dateUsed];
    
    NSDateFormatter* dateFormatter = [[NSDateFormatter alloc] init];
	[dateFormatter setDateStyle:NSDateFormatterMediumStyle];
    [dateFormatter setTimeStyle:NSDateFormatterShortStyle];
	NSString* dateUsedString = [dateFormatter stringFromDate:dateUsed];
    NSMutableString *dateUsedDisplayString = [[NSMutableString alloc] initWithString:@""];
    if(dateUsedString){
        [dateUsedDisplayString appendString:@"Last used "];
        [dateUsedDisplayString appendString:dateUsedString];
    }
    
    cell.dueDateLabel.text = dateUsedDisplayString;
    return cell;
}
